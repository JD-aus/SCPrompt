...
#AutoIt3Wrapper_Res_Fileversion=3.20.3.9
...
; Predefine variables
; ========================================
Global Const $s_Title = ' SCPrompt2020 Settings V3 '
...
If @Compiled Then
	TraySetToolTip("Settings Manager " & IniRead($SCPrompt_ini, "Common", "APPName", "SCPrompt 2020") & " - " & FileGetVersion(@ScriptFullPath))
Else
