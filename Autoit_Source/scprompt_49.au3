...
Global $INI_VNCFlavourSection = IniReadSection($AppINI, "VNCFlavours")
	...
	ElseIf $mode = "Stop" Then
		...
		ElseIf $UVNC_Installed_Path <> "" Then
			...
			Do
				...
				$V2M_EventDisplay = V2M_EventLog("SERVICE - Stopping Service, $LocalReturn = " & $LocalReturn & ", $Local_loop = " & $Local_loop & ", _Service_Running('uvnc_service') = " & _Service_Running("uvnc_service"), $V2M_EventDisplay, "8")
				Sleep(250)
				$Local_loop = $Local_loop + 1
